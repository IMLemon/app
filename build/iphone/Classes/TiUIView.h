...
/**
 Base class for all MiniProject views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MiniProject view hierarchy (such as wrapped iOS UIViews) was touched.
