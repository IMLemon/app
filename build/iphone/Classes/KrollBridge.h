...
@interface MiniProjectObject : KrollCoverageObject {
#else
@interface MiniProjectObject : KrollObject {
#endif
@private
...
extern NSString * MiniProject$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MiniProjectObject *_miniproject;
    KrollObject* console;
	BOOL shutdown;
