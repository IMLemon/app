...
//@interface MiniProjectObject : NSObject
//@end

@interface MiniProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MiniProjectObject class]])
		{
			for (NSString *key in [[(MiniProjectObject*)o modules] allKeys])
			{
