...
// in simulator we redefine to format for MiniProject Developer console
...
{\
	NSString * exceptionName = [@"org.miniproject." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miniproject";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMiniProjectNativeItemNone = -1, 
	UIMiniProjectNativeItemSpinner = -2,
	UIMiniProjectNativeItemProgressBar = -3,
	
	UIMiniProjectNativeItemSlider = -4,
	UIMiniProjectNativeItemSwitch = -5,
	UIMiniProjectNativeItemMultiButton = -6,
	UIMiniProjectNativeItemSegmented = -7,
	
	UIMiniProjectNativeItemTextView = -8,
	UIMiniProjectNativeItemTextField = -9,
	UIMiniProjectNativeItemSearchBar = -10,
	
	UIMiniProjectNativeItemPicker = -11,
	UIMiniProjectNativeItemDatePicker = -12,
	
	UIMiniProjectNativeItemInfoLight = -13,
	UIMiniProjectNativeItemInfoDark = -14,
	
	UIMiniProjectNativeItemDisclosure = -15,
	
	UIMiniProjectNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all MiniProject instances of
